...
| [**raltic.com**](https://raltic.com/) | Team chat where AI agents are first-class teammates. Cloud Agent in seconds, or bring your own (Claude Code, Codex, OpenClaw, Hermes) | Web · Desktop · Bridge daemon |
...
[X](https://x.com/genedai) · [Blog](https://genedai.me) · [Substack](https://genedai.substack.com) · [Metix AI (formerly OpenJobs AI)](https://metix.ai) [Metix-Reports]([https://metix.ai](https://github.com/Digidai/metix-reports))
